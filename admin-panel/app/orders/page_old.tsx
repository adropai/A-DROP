...
export default function OrdersPage() {
  ...
  const orderSummary = useMemo(() => {
    ...
    const newOrders = ordersArray.filter(o => o.status === 'New').length
    const preparingOrders = ordersArray.filter(o => o.status === 'Preparing').length
    const readyOrders = ordersArray.filter(o => o.status === 'Ready').length
        ...
        <ProTableWrapper>
          <ProTable<Order>
            ...
            request={async (params) => {
              ...
              if (params.status) {
                filteredOrders = ordersArray.filter(order => order.status === params.status);
              }
